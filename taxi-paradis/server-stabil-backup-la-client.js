...
<div id="oferta" style="display:none;border:2px solid red;padding:15px;margin-top:20px;background:#ffffcc;">

<div id="panouOferta">

<h3>🚖 COMANDĂ NOUĂ</h3>

<p><b>📍 Plecare:</b> <span id="plecare"></span></p>

<p><b>🏁 Destinație:</b> <span id="destinatie"></span></p>

<p><b>⏳ Timp rămas:</b> <span id="cronometru">15</span> secunde</p>

<button id="accepta">🟢 Acceptă</button>

<button id="refuza">🔴 Refuză</button>
...
<h3>🚖 CURSĂ ACCEPTATĂ TEST GABRIEL</h3>
...
<button id="laClient">✅ La client</button>
